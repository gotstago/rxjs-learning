// -- actions
export class AddCardGameAction { constructor(public gameId: number, public name: string) { } }
...
export type Action = AddTodoAction | ToggleTodoAction | SetVisibilityFilter | AddCardGameAction;
